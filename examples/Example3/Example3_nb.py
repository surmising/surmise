...
print('SSE PCGP = ', np.sum((p_1_mean - f_test)**2))

print('Rsq PCGP = ', 1 - np.sum(np.square(p_1_mean - f_test))/np.sum(np.square(f_test.T - np.mean(f_test, axis = 1))))
...
plot_pred(x_std, x, y, cal_3, theta_range)
